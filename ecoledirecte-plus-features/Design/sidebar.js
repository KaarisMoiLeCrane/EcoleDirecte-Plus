...
.note-parent:hover .tooltipp-green {
  top: -30px;
  opacity: 1;
  visibility: visible;
  pointer-events: auto;
...
.note-parent:hover .tooltipp-orange {
  top: -30px;
  opacity: 1;
  visibility: visible;
  pointer-events: auto;
...
.note-parent:hover .tooltipp-red {
  top: -30px;
  opacity: 1;
  visibility: visible;
  pointer-events: auto;
...
.tooltipp-red::before {
  text-shadow: 0px -1px 0px rgba(0, 0, 0, 0.1);
    ...
    if (!document.querySelector("#newMenu") && document.querySelector("#container-menu")) {
        ...
        for (let i = 0; i < document.querySelectorAll("ed-menu").length; i++) {
            ...
            if (i > 0) header.push('<header><div class="image-text"><span class="image"><img title="Photo de profile" src=' + edMenu[i].parentElement.parentElement.querySelector(".overlay").parentElement.style.backgroundImage.split("\"")[1] + '></span><div class="text"><span class="name">' + edMenu[i].parentElement.parentElement.querySelector(".overlay").innerText + '</span></div></div></header>')
